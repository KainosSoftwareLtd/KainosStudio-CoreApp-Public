...
When('I leave the select field unselected on the page', async function () {
    ...
    await driver.findElement(By.id('f-radio')).click();
});

When('I press the save and continue button to submit the empty select field', async function () {
...
Then('I should have an error appear at the top of the page related to the select that says {string}', async function (errorMessage: string) {
